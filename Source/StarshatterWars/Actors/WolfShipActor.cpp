...
void AWolfShipActor::ApplyWolfDefaults()
{
    ...
    BridgePointOffset =
        FVector(60.0f, 320.0f, 0.0f);

    ChasePointOffset =
        FVector(170.0f, -1800.0f, 0.0f);
    ...
    ReactorPointOffset =
        FVector(-220.0f, -40.0f, 0.0f);

    /*
     * Runtime thrusters own all thruster ports.
     * Disable generated fallback thruster system.
     */
