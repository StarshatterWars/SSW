...
enum class EMISSIONTYPE : uint8
{
	...
	INTERCEPT		UMETA(DisplayName = "Sweep"),
	AIR_PATROL		UMETA(DisplayName = "Air Patrol"), 
	AIR_SWEEP		UMETA(DisplayName = "Air Sweep"),
	AIR_INTERCEPT	UMETA(DisplayName = "Air Intercept"),
	STRIKE			UMETA(DisplayName = "Ground Attack"),      // ground attack
	ASSAULT			UMETA(DisplayName = "Assault"),		       // starship attack
	DEFEND			UMETA(DisplayName = "Defend"),
	ESCORT			UMETA(DisplayName = "Escort"),
	ESCORT_FREIGHT	UMETA(DisplayName = "Escort Freight"),
	ESCORT_SHUTTLE	UMETA(DisplayName = "Escort Shuttle"),
	ESCORT_STRIKE	UMETA(DisplayName = "Escort Strike"),
	INTEL			UMETA(DisplayName = "Intel"),
	...
	FLIGHT_OPS		UMETA(DisplayName = "Flight Ops"),
	TRANSPORT		UMETA(DisplayName = "Transport"),
...
UENUM(BlueprintType)
enum class EMISSIONFIGHTER : uint8
{
	FIGHTER			UMETA(DisplayName = "Fighter"),
...
struct FS_Campaign : public FTableRowBase {
	...
	TSoftObjectPtr<UTexture2D> CampaignImage;
...
struct FMedalInfo : public FTableRowBase
{
	...
	int32 MedalId = 0; // if you truly need bitmask semantics keep it as-is
